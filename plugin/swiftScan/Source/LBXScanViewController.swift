 ...
 //返回扫码结果，也可以通过继承本控制器，改写该handleCodeResult方法即可
   ...
   public  var isNeedCodeImage = false
    ...
    override open func viewDidLoad() {
        ...
        button = {
            let b = UIButton.init(frame: CGRect.init(x: 20, y: self.view.frame.height-60, width: self.view.frame.width-40, height: 49))
            b.setTitle("取消", for: UIControlState.normal)
            b.backgroundColor = UIColor.lightGray
            b.layer.cornerRadius = 5
            b.layer.masksToBounds = true
            b.addTarget(self, action: #selector(popVC), for: UIControlEvents.touchUpInside)
            return b
        }()
